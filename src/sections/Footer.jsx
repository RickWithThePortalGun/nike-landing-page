      ...
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 text-white-400 sm:max-w-sm font-montserrat">
            Get shoes ready for the new year at your nearest Nike store. Find
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link)=>(
                  <li className="mt-3 text-white-400 leading-normal text-base cursor-pointer hover:text-slate-gray">
                    <a href="">{link.name}</a>
                  </li>
                ))}
              </ul>
